...
std::string ChordSymbol::toText(ChordSymbolFormat fmt)
{
	...
	if (auto s = [&]() -> std::string {
		...
		if (quality & ChordQualityFlags::Maj9)
			return u8"\u03949";
		if (quality & ChordQualityFlags::SixNine)
			return "6/9";
	...
	if (quality & ChordQualityFlags::Omit3)
		alterations.emplace_back("omit3");
	if (quality & ChordQualityFlags::Add2)
		alterations.emplace_back("add2");
	if (quality & ChordQualityFlags::Sus2Post)
		alterations.emplace_back("sus2");
	if (quality & ChordQualityFlags::SusPost)
		alterations.emplace_back("sus");
	if (quality & ChordQualityFlags::Sus4Post)
		alterations.emplace_back("sus4");
	if (quality & ChordQualityFlags::Sharp4)
		alterations.emplace_back(u8"♯4");
	if (quality & ChordQualityFlags::Omit5)
		alterations.emplace_back("omit5");
	if (quality & ChordQualityFlags::Flat5)
		alterations.emplace_back(u8"♭5");
	if (quality & ChordQualityFlags::Sharp5)
		alterations.emplace_back(u8"♯5");
	if (quality & ChordQualityFlags::Min6Post)
		alterations.emplace_back("min6");
	if (quality & ChordQualityFlags::Flat6Post)
		alterations.emplace_back(u8"♭6");
	if (quality & ChordQualityFlags::Aug6)
		alterations.emplace_back("+6");
	if (quality & ChordQualityFlags::Maj7Post)
		alterations.emplace_back("maj7");
	if (quality & ChordQualityFlags::Flat9)
		alterations.emplace_back(u8"♭9");
	if (quality & ChordQualityFlags::Add9)
		alterations.emplace_back("add9");
	if (quality & ChordQualityFlags::Sharp9)
		alterations.emplace_back(u8"♯9");
	if (quality & ChordQualityFlags::Add11)
		alterations.emplace_back("add11");
	if (quality & ChordQualityFlags::Sharp11)
		alterations.emplace_back(u8"♯11");
	if (quality & ChordQualityFlags::Flat13)
		alterations.emplace_back(u8"♭13");
	if (quality & ChordQualityFlags::Alt)
		alterations.emplace_back("alt");
	if (quality & ChordQualityFlags::Sharp15)
		alterations.emplace_back(u8"♯15");
