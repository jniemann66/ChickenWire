...
QtObject {
    ...
    readonly property var presets: ({
                                        "dark": {
                                            ...
                                            "selStroke": "#ffd700",
                                            "selText": "#fff8dc",
                                            "selTriadFill": Qt.rgba(
                                                                1.000, 0.824,
                                                                0.235, 0.28),
                                            "selTriadStroke": Qt.rgba(
                                                                  1.000, 0.824,
                                                                  0.235, 0.70),
                                            "selHexFill": Qt.rgba(1.000, 0.824,
                                                                  0.235, 0.18),
                                            "selHexStroke": Qt.rgba(
                                                                1.000, 0.824,
                                                                0.235, 0.60),
                                            "hlFaceFill": Qt.rgba(1.000, 0.824,
                                                                  0.235, 0.28),
                                            "hlEdge": Qt.rgba(1.000, 0.824,
                                                              0.235, 0.70),
                                            "hlHexStroke": Qt.rgba(1.000,
                                                                   0.824,
                                                                   0.235, 0.60),
                                            "hlNodeFill": "#b8860b",
                                            "hlColor": "#ffd700"
                                        ...
                                        "light": {
                                            "background"// Monochrome white background; all edges the same grey;
                                            ...
                                            "selTriadStroke": Qt.rgba(
                                                                  1.000, 0.843,
                                                                  0.000, 0.70),
                                            "selHexFill": Qt.rgba(1.000, 0.843,
                                                                  0.000, 0.18),
                                            "selHexStroke": Qt.rgba(
                                                                1.000, 0.843,
                                                                0.000, 0.60),
                                            "hlFaceFill": Qt.rgba(1.000, 0.843,
                                                                  0.000, 0.25),
                                            "hlEdge": Qt.rgba(1.000, 0.843,
                                                              0.000, 0.70),
                                            "hlHexStroke": Qt.rgba(1.000,
                                                                   0.843,
                                                                   0.000, 0.60),
                                        ...
                                        "contrast": {
                                            "background"// Pure black background with fully-saturated edge colours.
                                            : "#000000",
                                            "nodeFill": "#0d0d1a",
                                            "nodeStroke": "#cccccc",
                                            "nodeText": "#ffffff",
